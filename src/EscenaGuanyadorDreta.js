class escenaGuanyadorDreta extends Phaser.Scene {
    constructor() {
        super({ key: 'escenaGuanyadorDreta' });
    }
    ...
    create() {
        var GuanyaEsquerre = this.add.text(100, 200, 'GUANYADOR: JUGADOR 1');
        ...
        question.on('pointerdown', function (event) {
            ...
            this.scene.remove('escenaGuanyadorDreta')
